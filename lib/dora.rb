...
# All global variables used to connect with WhatsApp
module Dora
  ...
  WHATSAPP_VER            = '2.12.556'                   # Version
  WHATSAPP_USER_AGENT     = 'WhatsApp/2.12.556 Android/4.3 Device/Xiaomi-HM_1SW'       # User agent used in request/registration code.
